                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>****</td>
                                    <td>
                                        <a href="edit_user.php?id=<?= $id ?>" id="btnEdit" name="btnEdit" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                        <button id="btnDelete" name="btnDelete" data-toggle="tooltip" title="Delete" class="btn btn-danger" onclick="deleteUser(<?= $id ?>)"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                    </td>
                                </tr>
                            ...
                            <div class="custom-pagination">
                                <ul class="pagination">
                                    ...
                                    ?>
                                                <li class="page-item"><a class="page-link" href="users-list.php?pagina=<?= ($i-1) ?>"><?= $i ?></a></li>
                                    <?php
                                            }
                                        }
                                    ?>
    ...
    <script src="js/alertify.min.js"></script>
        <script>
            ...
            function deleteUser(id){
                alertify.confirm("Do you want to delete User #"+id+" and all its data?",
                  function(){
                    $.ajax({
                      url: 'delete_user.php',
                      method: 'POST',
