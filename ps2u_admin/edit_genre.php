...
<?php
    if (isset($_POST["btnSave"])) {
        ...
        $sqlGames="UPDATE generos SET nombre=? WHERE id_genero=?";

        $pre=mysqli_prepare($conexion,$sqlGames);

        if ($pre) {
            mysqli_stmt_bind_param($pre,"si",$genre,$id);
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Genre Edit</a></li>
                                </ul>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                       <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input id="txtGenre" name="txtGenre" type="text" class="form-control" placeholder="Genre" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
