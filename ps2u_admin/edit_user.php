...
<?php
    if (isset($_POST["btnSave"])) {
        ...
        $sqlGames="UPDATE usuarios SET nick=?, email=? WHERE id_user=?";

        $pre=mysqli_prepare($conexion,$sqlGames);

        if ($pre) {
            mysqli_stmt_bind_param($pre,"ssi",$nick,$email,$id);
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input id="txtNick" name="txtNick" type="text" class="form-control" required>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
