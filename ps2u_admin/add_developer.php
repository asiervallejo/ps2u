...
<?php 
    ...
    if (isset($_POST["btnSave"])) {
        ...
        $sql="INSERT INTO desarrolladores (nombre) VALUES (?)";
        // Preparar la sentencia
        $pre=mysqli_prepare($conexion,$sql);
        //Vincular los parámetros
        if ($pre) {
            mysqli_stmt_bind_param($pre,"s",$developer);
        ...
        if ($lastId) {
            header("Location: developer-list.php");
        }
        else
        {
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#"><i class="icon nalika-edit" aria-hidden="true"></i>Add Developer</a></li>
                                </ul>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input id="txtDeveloper" name="txtDeveloper" type="text" class="form-control" placeholder="Developer" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <input type="submit" id="btnSave" name="btnSave" class="btn btn-ctl-bt waves-effect waves-light m-r-10" value="Add">
