                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="btn-group images-cropper-pro">
                                                        ...
                                                        <div id="imageDiv" name="imageDiv" class="image-crop">
                                                            <img id="image" name="image" src="img/cropper/1.jpg" alt="" class="w-25"><input type="hidden" name="txtFileName" id="txtFileName" value="<?= $filename ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    $.each(data,function(index,value){
                        code+='<figure class="col-md-4">'+
                                    '<a href="#" data-size="1600x1067">'+
                                        '<img onclick="eliminarImagen('+value.id+')" alt="picture" src="'+value.url+'" class="img-fluid">'+
                                    '</a>'+
                                '</figure>';
                    })
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        var code='<figure class="col-md-4">'+
                                    '<a href="#" data-size="1600x1067">'+
                                        '<img alt="picture" src="'+data+'" class="img-fluid">'+
                                    '</a>'+
                                '</figure>';
