...
<?php
    if (isset($_POST["btnSave"])) {
        ...
        $sqlGames="UPDATE desarrolladores SET nombre=? WHERE id_desarrollador=?";

        $pre=mysqli_prepare($conexion,$sqlGames);

        if ($pre) {
            mysqli_stmt_bind_param($pre,"si",$developer,$id);
...
<body>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <form action="" method="POST" id="myTabContent" class="tab-content custom-product-edit">
                                    <!-- Game Menu -->
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                       <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input id="txtDeveloper" name="txtDeveloper" type="text" class="form-control" placeholder="Developer">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        $(function(){
            ...
            //Datos de cada juego:
            $.ajax({
                url:"developer_data.php",
                method:"POST",
                dataType:"json",
                data:{id: id},
                success: function(data){
                    console.log(data);
                    $("#txtDeveloper").val(data.nombre);
                },
