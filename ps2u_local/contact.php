...
<body>
	...
	<section class="contact-page">
		<div class="container">
			<div class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2902.72805788712!2d-1.973985684976201!3d43.319951881934415!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd51a55cf327505d%3A0x566d74618bc8bd9c!2sNazaret%20Fundazioa!5e0!3m2!1ses!2ses!4v1593776524903!5m2!1ses!2ses" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></div>
			<div class="row">
				...
				<div class="col-lg-5 order-1 order-lg-2 contact-text text-white">
					...
					<div class="cont-info">
						...
						<div class="ci-text">Aldakonea, 36, 20012 Donostia, Gipuzkoa</div>
					</div>
					<div class="cont-info">
						<div class="ci-icon"><img src="img/icons/phone.png" alt=""></div>
						<div class="ci-text">+666 666666</div>
					</div>
					<div class="cont-info">
						<div class="ci-icon"><img src="img/icons/mail.png" alt=""></div>
						<div class="ci-text">ps2u_games@gmail.com</div>
					</div>
				</div>
			</div>
		</div>
