				...
				<div class="col-4">
					<form id="formRegistro" name="formRegistro" class="form p-5 text-center" action="registerUser.php" method="POST">
	                    <div class="form-group mb-5">
	                        <label for="txtUsuario" hidden>User</label>
	                        <input type="text" class="form-control" id="txtUsuario" name="txtUsuario"  placeholder="User Name" required>
	                    </div>
	                    <div class="form-group mb-5">
	                    ...
	                    <button class="btn btn-primary favoritos" type="submit" id="btnIngresar" name="btnIngresar">Register</button>
